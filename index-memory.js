// index.js - Porsuk Ticket Bot - Basit Hafıza/Memory Sürümü
...
const storage = {
  ...
  async getUserByDiscordId(discordId) {
    return memoryStorage.users.find(user => user.discord_id === discordId);
  },
...
async function handleTicketCreation(message, categoryId, description) {
  try {
    ...
    try {
      ...
      if (!ticket) {
        return message.reply('Ticket kaydedilemedi.');
      }
